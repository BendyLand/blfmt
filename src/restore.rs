...
pub fn restore_example_cpp_file() {
    let temp1 = fs::read_to_string("/Users/benlandrette/ccode/serious-projects/bendyland/blfmt/safe.cpp").unwrap().to_owned();
    let good1 = temp1.as_bytes();
    let mut file1 = fs::File::create("/Users/benlandrette/ccode/serious-projects/bendyland/blfmt/test.cpp").expect("Unable to get example_file.cpp");
